...
`;
  ...
  const getComponentInfo = useCallback((element) => {
  ...
  const handleElementLeave = useCallback((e) => {
    if (!selectorMode) return;
    const target = e.target;
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: "8px" }, children: [
            /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: "8px" }, children: [
              /* @__PURE__ */ jsx("span", { style: { color: "#a78bfa", fontSize: "12px", fontWeight: "600" }, children: "DEV" }),
              /* @__PURE__ */ jsx("span", { style: { color: "#9ca3af", fontSize: "12px" }, children: "|" }),
              /* @__PURE__ */ jsx(
                "button",
                {
                  onClick: () => {
          ...
          /* @__PURE__ */ jsxs("div", { style: { marginTop: "8px" }, children: [
            /* @__PURE__ */ jsxs("div", { style: { fontSize: "12px", color: "#d1d5db", display: "flex", alignItems: "center", gap: "4px" }, children: [
              "Page:",
              justCopied && !selectedComponent && /* @__PURE__ */ jsx("span", { style: { color: "#34d399", fontSize: "12px", animation: "dev-page-indicator-pulse 2s infinite" }, children: "\u2713 Copied!" })
            ] }),
            /* @__PURE__ */ jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsx("span", { style: { color: "#6b7280", transition: "color 0.2s" }, children: "\u{1F4CB}" }),
                  pageFile
                ]
              }
            )
          ] }),
          selectedComponent && /* @__PURE__ */ jsxs("div", { className: "mt-2 pt-2 border-t border-gray-700", children: [
            /* @__PURE__ */ jsxs("div", { className: "text-xs text-gray-300 flex items-center justify-between", children: [
              /* @__PURE__ */ jsx("span", { children: "Selected Component:" }),
              /* @__PURE__ */ jsx(
                "button",
                {
            ...
            /* @__PURE__ */ jsx("div", { className: "text-sm font-bold text-blue-400 mt-1", children: selectedComponent.name }),
            selectedComponent.parentComponent && /* @__PURE__ */ jsxs("div", { className: "text-xs text-purple-400 mt-1", children: [
              "Parent: ",
              selectedComponent.parentComponent
            ] }),
            selectedComponent.file && /* @__PURE__ */ jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsx("span", { className: "text-gray-500 group-hover:text-gray-400 transition-colors", children: "\u{1F4CB}" }),
                  selectedComponent.file
                ]
              }
            ),
            !selectedComponent.file && selectedComponent.parentComponent && /* @__PURE__ */ jsx("div", { className: "text-xs text-gray-400 mt-1 italic", children: "This element is part of the parent component" }),
            selectedComponent.props && selectedComponent.props.length > 0 && /* @__PURE__ */ jsxs("div", { className: "mt-1", children: [
              /* @__PURE__ */ jsx("span", { className: "text-xs text-gray-400", children: "Classes:" }),
              /* @__PURE__ */ jsxs("div", { className: "text-xs text-gray-300 font-mono mt-1 max-h-20 overflow-y-auto", children: [
                selectedComponent.props.slice(0, 3).join(", "),
                selectedComponent.props.length > 3 && ` +${selectedComponent.props.length - 3} more`
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsx("div", { style: { marginTop: "8px", paddingTop: "8px", borderTop: "1px solid #374151" }, children: /* @__PURE__ */ jsxs("div", { style: { fontSize: "12px", color: "#9ca3af", fontFamily: "monospace" }, children: [
            "Route: ",
            pathname
          ] }) }),
          showShortcutHints && (selectorMode || selectedComponent) && /* @__PURE__ */ jsxs("div", { className: "mt-2 pt-2 border-t border-gray-700", children: [
            selectorMode && /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsx("div", { className: "text-xs text-yellow-400 animate-pulse", children: "\u26A1 Click any element to inspect" }),
              /* @__PURE__ */ jsx("div", { className: "text-xs text-gray-400 mt-1", children: "Press ESC to cancel" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "text-xs text-gray-500 mt-1", children: [
              /* @__PURE__ */ jsx("span", { className: "text-gray-600", children: "Shortcut:" }),
              " ",
              " ",
              /* @__PURE__ */ jsx("kbd", { className: "px-1 py-0.5 text-xs bg-gray-800 rounded", children: "\u2318/Ctrl" }),
              /* @__PURE__ */ jsx("span", { className: "mx-0.5", children: "+" }),
              /* @__PURE__ */ jsx("kbd", { className: "px-1 py-0.5 text-xs bg-gray-800 rounded", children: "Shift" }),
              /* @__PURE__ */ jsx("span", { className: "mx-0.5", children: "+" }),
              /* @__PURE__ */ jsx("kbd", { className: "px-1 py-0.5 text-xs bg-gray-800 rounded", children: "C" }),
              /* @__PURE__ */ jsx("span", { className: "ml-1 text-gray-600", children: "to copy all" })
            ] })
          ] })
        ]
      }
    ),
    selectorMode && hoveredComponent && /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxs("div", { className: "bg-purple-900/95 backdrop-blur-sm text-white px-3 py-2 rounded-lg shadow-lg border border-purple-500", children: [
          /* @__PURE__ */ jsx("div", { className: "text-sm font-bold", children: hoveredComponent.name }),
          hoveredComponent.parentComponent && /* @__PURE__ */ jsxs("div", { className: "text-xs text-purple-200 mt-1", children: [
            "Parent: ",
            hoveredComponent.parentComponent
          ] }),
          hoveredComponent.file && /* @__PURE__ */ jsx("div", { className: "text-xs text-purple-300 mt-1", children: hoveredComponent.file }),
          !hoveredComponent.file && !hoveredComponent.parentComponent && /* @__PURE__ */ jsx("div", { className: "text-xs text-purple-200 mt-1 italic", children: "DOM Element" })
        ] })
      }
    )
  ] });
...
function withDevIdentify(Component, componentName, componentFile) {
  ...
  const WrappedComponent = (props) => {
    return /* @__PURE__ */ jsx2("div", { ...devIdentify(componentName, componentFile), children: /* @__PURE__ */ jsx2(Component, { ...props }) });
  };
  WrappedComponent.displayName = `DevIdentified(${componentName})`;
  return WrappedComponent;
}
export {
  DevPageIndicator_default as DevPageIndicator,
  devIdentify,
  withDevIdentify
};
